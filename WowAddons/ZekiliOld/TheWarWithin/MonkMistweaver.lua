...
spec:RegisterSetting( "save_faeline", false, {
    ...
    desc = strformat( "If checked, %s will not be recommended when %s, %s, and/or %s are active.\n\n"
        ...
        Zekili:GetSpellLinkWithTexture( spec.auras.ancient_concordance.id ), Zekili:GetSpellLinkWithTexture( spec.auras.ancient_teachings.id ),
        Zekili:GetSpellLinkWithTexture( spec.auras.awakened_jadefire.id ) ),
    width = "full",
} )
...
spec:RegisterSetting( "aoe_rsk", false, {
    type = "toggle",
    name = strformat( "%s: AOE", Zekili:GetSpellLinkWithTexture( spec.abilities.rising_sun_kick.id ) ),
    desc = strformat( "If checked, %s may be recommended when there are more than 3 enemies detected.\n\n"
        ...
        Zekili:GetSpellLinkWithTexture( brm.abilities.rising_sun_kick.id ), Zekili:GetSpellLinkWithTexture( spec.abilities.enveloping_mist.id ) ),
    width = "full",
} )
