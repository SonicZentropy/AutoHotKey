...
local spec = Zekili:NewSpecialization( 577 )
...
do
    ...
    spec:RegisterEvent( "PLAYER_REGEN_DISABLED", function ()
        if state.talent.demon_blades.enabled and not state.settings.demon_blades_acknowledged and not wasWarned then
            Zekili:Notify( "|cFFFF0000WARNING!|r  Demon Blades cannot be forecasted.\nSee /zekili > Havoc for more information." )
            wasWarned = true
        end
    end )
end
...
spec:RegisterSetting( "demon_blades_text", nil, {
    name = function()
        return strformat( "|cFFFF0000WARNING!|r  If using the %s talent, Fury gains from your auto-attacks will be forecast conservatively and updated when you "
            ...
            .. "your next melee swing.", Zekili:GetSpellLinkWithTexture( 203555 ) )
    end,
    type = "description",
    width = "full"
} )
...
spec:RegisterSetting( "demon_blades_acknowledged", false, {
    name = function()
        return strformat( "I understand that Fury generation from %s is unpredictable.", Zekili:GetSpellLinkWithTexture( 203555 ) )
    end,
    desc = function()
        return strformat( "If checked, %s will not trigger a warning when entering combat.", Zekili:GetSpellLinkWithTexture( 203555 ) )
    end,
    type = "toggle",
    width = "full",
...
spec:RegisterSetting( "fel_rush_head", nil, {
    name = Zekili:GetSpellLinkWithTexture( 195072, 20 ),
    type = "header"
} )
...
spec:RegisterSetting( "fel_rush_warning", nil, {
    name = strformat( "The %s, %s, and/or %s talents require the use of %s.  If you do not want |W%s|w to be recommended to trigger these talents, you may want to "
        ...
        .. "cost you DPS.", Zekili:GetSpellLinkWithTexture( 388113 ), Zekili:GetSpellLinkWithTexture( 206476 ), Zekili:GetSpellLinkWithTexture( 347461 ),
        Zekili:GetSpellLinkWithTexture( 195072 ), spec.abilities.fel_rush.name, spec.abilities.fel_rush.name, spec.abilities.fel_rush.name ),
    type = "description",
    width = "full",
} )

spec:RegisterSetting( "fel_rush_charges", 0, {
    name = strformat( "Reserve %s Charges", Zekili:GetSpellLinkWithTexture( 195072 ) ),
    desc = strformat( "If set above zero, %s will not be recommended if it would leave you with fewer (fractional) charges.", Zekili:GetSpellLinkWithTexture( 195072 ) ),
    type = "range",
    min = 0,
    max = 2,
    step = 0.1,
...
spec:RegisterSetting( "fel_rush_filler", true, {
    name = strformat( "%s: Filler and Movement", Zekili:GetSpellLinkWithTexture( 195072 ) ),
    desc = strformat( "When enabled, %s may be recommended as a filler ability or for movement.\n\n"
        ...
        Zekili:GetSpellLinkWithTexture( 195072 ), Zekili:GetSpellLinkWithTexture( 203555 ) ),
    type = "toggle",
    width = "full"
} )
...
spec:RegisterSetting( "throw_glaive_head", nil, {
    name = Zekili:GetSpellLinkWithTexture( 185123, 20 ),
    type = "header"
} )
...
spec:RegisterSetting( "throw_glaive_charges_text", nil, {
    name = strformat( "You can reserve charges of %s to ensure that it is always available for %s or |W|T1385910:0::::64:64:4:60:4:60|t |cff71d5ff%s (affix)|r|w procs. "
        ...
        Zekili:GetSpellLinkWithTexture( 185123 ), Zekili:GetSpellLinkWithTexture( 391429 ), GetSpellInfo( 396363 ).name, Zekili:GetSpellLinkWithTexture( 389763 ),
...
spec:RegisterSetting( "throw_glaive_charges", 0, {
    name = strformat( "Reserve %s Charges", Zekili:GetSpellLinkWithTexture( 185123 ) ),
    desc = strformat( "If set above zero, %s will not be recommended if it would leave you with fewer (fractional) charges.", Zekili:GetSpellLinkWithTexture( 185123 ) ),
    type = "range",
    min = 0,
    max = 2,
    step = 0.1,
...
spec:RegisterSetting( "footloose", true, {
    name = strformat( "%s before %s", Zekili:GetSpellLinkWithTexture( 185123 ) , Zekili:GetSpellLinkWithTexture( 188499 ) ),
    desc = strformat( "When enabled, %s may be recommended without having %s on cooldown.\n\n"
        ...
        Zekili:GetSpellLinkWithTexture( 185123 ) , Zekili:GetSpellLinkWithTexture( 188499 ) ),
    type = "toggle",
    width = "full"
} ) ]]
...
spec:RegisterSetting( "retreat_head", nil, {
    name = Zekili:GetSpellLinkWithTexture( 198793, 20 ),
    type = "header"
} )
...
spec:RegisterSetting( "retreat_warning", nil, {
    name = strformat( "The %s, %s, and/or %s talents require the use of %s.  If you do not want |W%s|w to be recommended to trigger the benefit of these talents, you "
        .. "may want to consider a different talent build.", Zekili:GetSpellLinkWithTexture( 388108 ),Zekili:GetSpellLinkWithTexture( 206476 ),
        Zekili:GetSpellLinkWithTexture( 389688 ), Zekili:GetSpellLinkWithTexture( 198793 ), spec.abilities.vengeful_retreat.name ),
    type = "description",
    width = "full",
} )

spec:RegisterSetting( "retreat_and_return", "off", {
    name = strformat( "%s: %s and %s", Zekili:GetSpellLinkWithTexture( 198793 ), Zekili:GetSpellLinkWithTexture( 195072 ), Zekili:GetSpellLinkWithTexture( 232893 ) ),
    desc = function()
        return strformat( "When enabled, %s will |cFFFF0000NOT|r be recommended unless either %s or %s are available to quickly return to your current target.  This "
            ...
            Zekili:GetSpellLinkWithTexture( 198793 ), Zekili:GetSpellLinkWithTexture( 195072 ), Zekili:GetSpellLinkWithTexture( 232893 ),
    ...
    values = {
        ...
        fel_rush = "Require " .. Zekili:GetSpellLinkWithTexture( 195072 ),
        felblade = "Require " .. Zekili:GetSpellLinkWithTexture( 232893 ),
        either = "Either " .. Zekili:GetSpellLinkWithTexture( 195072 ) .. " or " .. Zekili:GetSpellLinkWithTexture( 232893 )
    },
    width = "full"
} )

spec:RegisterSetting( "retreat_filler", false, {
    name = strformat( "%s: Filler and Movement", Zekili:GetSpellLinkWithTexture( 198793 ) ),
    desc = function()
