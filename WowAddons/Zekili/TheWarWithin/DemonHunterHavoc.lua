...
spec:RegisterHook( "reset_precast", function ()
    ...
    if talent.demonsurge.enabled and buff.metamorphosis.up then
        ...
        if talent.demonic_intensity.enabled then
            ...
            for _, list in pairs( demonsurge ) do
                for _, name in ipairs( list ) do
                    ...
                    if Zekili.ActiveDebug then
                        Zekili:Debug( " - " .. ( hasPending and "PASS: " or "FAIL: " ) ..
            ...
            if Zekili.ActiveDebug then
                Zekili:Debug( " - buff.demonsurge.stack[" .. buff.demonsurge.stack - pending .. " + " .. pending .. "]" )
            end
        end

        if Zekili.ActiveDebug then
            Zekili:Debug( "Demonsurge status:\n" ..
