...
local spec = Zekili:NewSpecialization( 262 )
...
spec:RegisterSetting( "stack_buffer", 1.1, {
    name = strformat( "%s and %s Padding", Zekili:GetSpellLinkWithTexture( spec.abilities.icefury.id ), Zekili:GetSpellLinkWithTexture( spec.abilities.stormkeeper.id ) ),
    desc = strformat( "The default priority tries to avoid wasting %s and %s stacks with a grace period of 1.1 GCD per stack.\n\n" ..
            ...
            Zekili:GetSpellLinkWithTexture( spec.abilities.icefury.id ), Zekili:GetSpellLinkWithTexture( spec.abilities.stormkeeper.id ), spec.abilities.icefury.name,
