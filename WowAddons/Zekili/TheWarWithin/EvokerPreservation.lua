...
local spec = Zekili:NewSpecialization( 1468 )
...
spec:RegisterSetting( "use_deep_breath", true, {
    name = strformat( "Use %s", Zekili:GetSpellLinkWithTexture( 357210 ) ),
    type = "toggle",
    desc = strformat( "If checked, %s may be recommended, which will force your character to select a destination and move.  By default, %s requires your Cooldowns "
        ...
        Zekili:GetSpellLinkWithTexture( 357210 ), deep_breath, deep_breath ),
    width = "full",
} )
...
spec:RegisterSetting( "use_unravel", false, {
    ...
    desc = strformat( "If checked, %s may be recommended if your target has an absorb shield applied.  By default, %s also requires your Interrupts toggle to be active.",
        Zekili:GetSpellLinkWithTexture( 368432 ), unravel ),
    width = "full",
} )
...
spec:RegisterSetting( "spend_essence", false, {
    name = strformat( "%s: Spend Essence", Zekili:GetSpellLinkWithTexture( devastation.abilities.disintegrate.id ) ),
    type = "toggle",
    desc = strformat( "If checked, %s may be recommended when you will otherwise max out on Essence and risk wasting resources.\n\n"
        .. "Recommendation: Leave disabled in content where you are actively healing and spending Essence on healing spells.", Zekili:GetSpellLinkWithTexture( devastation.abilities.disintegrate.id ) ),
    width = "full"
} )
