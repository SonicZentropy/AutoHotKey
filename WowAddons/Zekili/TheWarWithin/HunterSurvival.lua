...
local spec = Zekili:NewSpecialization( 255 )
...
spec:RegisterSetting( "pet_healing", 0, {
    ...
    desc = strformat( "If set above zero, %s will be recommended when your pet falls below this health percentage. Set to 0 to disable the feature.", Zekili:GetSpellLinkWithTexture( beastMastery.abilities.mend_pet.id ) ),
    icon = 132179,
...
spec:RegisterSetting( "use_harpoon", true, {
    name = strformat( "Use %s", Zekili:GetSpellLinkWithTexture( spec.abilities.harpoon.id ) ),
    desc = strformat( "If checked, %s will be recommended when you are out of range and it is available.", Zekili:GetSpellLinkWithTexture( spec.abilities.harpoon.id ) ),
    type = "toggle",
    width = "full"
} )
