...
spec:RegisterSetting( "cleave_apl", false, {
    ...
    desc = function()
        ...
        "You may wish to change this option for different fights and scenarios, which can be done here, via the minimap button, or with |cFFFFD100/zekili toggle cleave_apl|r."
    end,
    type = "toggle",
    width = "full",
} )
