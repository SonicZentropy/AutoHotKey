...
spec:RegisterHook( "reset_precast", function ()
    ...
    if Zekili.ActiveDebug then
        if active_feral_spirits > 0 then Zekili:Debug( "Feral Spirits: " .. active_feral_spirits ) end
        if active_molten_weapons > 0 then Zekili:Debug( "Molten Weapons: " .. active_molten_weapons ) end
        if active_icy_edges > 0 then Zekili:Debug( "Icy Edges: " .. active_icy_edges ) end
        if active_crackling_surges > 0 then Zekili:Debug( "Crackling Surges: " .. active_crackling_surges ) end
        if active_earthen_weapons > 0 then Zekili:Debug( "Earthen Weapons: " .. active_earthen_weapons ) end
    end
