...
local spec = Zekili:NewSpecialization( 104 )
...
spec:RegisterSetting( "maul_rage", 20, {
    name = strformat( "%s (or %s) Rage Threshold", Zekili:GetSpellLinkWithTexture( spec.abilities.maul.id ), Zekili:GetSpellLinkWithTexture( spec.abilities.raze.id ) ),
    desc = strformat( "If set above zero, %s and %s can be recommended only if you'll still have this much Rage after use.\n\n"
        ...
        Zekili:GetSpellLinkWithTexture( spec.abilities.maul.id ), Zekili:GetSpellLinkWithTexture( spec.abilities.raze.id ),
        Zekili:GetSpellLinkWithTexture( spec.abilities.ironfur.id ), Zekili:GetSpellLinkWithTexture( spec.abilities.frenzied_regeneration.id ) ),
    type = "range",
    min = 0,
    max = 60,
    step = 0.1,
...
spec:RegisterSetting( "maul_anyway", true, {
    name = strformat( "Use %s and %s in %s Build", Zekili:GetSpellLinkWithTexture( spec.abilities.maul.id ), Zekili:GetSpellLinkWithTexture( spec.abilities.raze.id ),
        Zekili:GetSpellLinkWithTexture( spec.abilities.ironfur.id ) ),
    desc = strformat( "If checked, %s and %s are recommended more frequently even if you have talented %s or %s.\n\n"
        .. "This differs from the default SimulationCraft priority as of February 2023.", Zekili:GetSpellLinkWithTexture( spec.abilities.maul.id ),
        Zekili:GetSpellLinkWithTexture( spec.abilities.raze.id ), Zekili:GetSpellLinkWithTexture( spec.talents.layered_mane[2] ), Zekili:GetSpellLinkWithTexture( spec.talents.reinforced_fur[2] ) ),
    type = "toggle",
    width = "full",
} )
...
spec:RegisterSetting( "ironfur_damage_threshold", 5, {
    name = strformat( "%s Damage Threshold", Zekili:GetSpellLinkWithTexture( spec.abilities.ironfur.id ) ),
    desc = strformat( "If set above zero, %s will not be recommended for mitigation purposes unless you've taken this much damage in the past 5 seconds (as a percentage "
        ...
        .. "Taking %s and %s will result in |W%s|w recommendations for offensive purposes.", Zekili:GetSpellLinkWithTexture( spec.abilities.ironfur.id ),
        Zekili:GetSpellLinkWithTexture( spec.talents.thorns_of_iron[2] ), Zekili:GetSpellLinkWithTexture( spec.talents.reinforced_fur[2] ), spec.abilities.ironfur.name ),
    type = "range",
    min = 0,
    max = 200,
    step = 0.1,
...
spec:RegisterSetting( "max_ironfur", 1, {
    name = strformat( "%s Maximum Stacks", Zekili:GetSpellLinkWithTexture( spec.abilities.ironfur.id ) ),
...
spec:RegisterSetting( "catweave_bear", false, {
    name = strformat( "Weave %s and %s", Zekili:GetSpellLinkWithTexture( spec.abilities.cat_form.id ), Zekili:GetSpellLinkWithTexture( spec.abilities.bear_form.id ) ),
    desc = strformat( "If checked, shifting between %s and %s may be recommended based on whether you're actively tanking and other conditions.  These swaps may occur "
        ...
        Zekili:GetSpellLinkWithTexture( spec.abilities.cat_form.id ), Zekili:GetSpellLinkWithTexture( spec.abilities.bear_form.id ),
