...
spec:RegisterSetting( "maul_anyway", true, {
    ...
    desc = strformat( "If checked, %s and %s are recommended more frequently even if you have talented %s or %s.\n\n"
        ...
        Zekili:GetSpellLinkWithTexture( spec.talents.layered_mane[2] ), Zekili:GetSpellLinkWithTexture( spec.talents.reinforced_fur[2] ) ),
    type = "toggle",
    width = "full",
} )
...
spec:RegisterSetting( "ironfur_damage_threshold", 5, {
    ...
    desc = strformat( "If set above zero, %s will not be recommended for mitigation purposes unless you've taken this much damage in the past 5 seconds (as a percentage "
        ...
        Zekili:GetSpellLinkWithTexture( spec.abilities.ironfur.id ), Zekili:GetSpellLinkWithTexture( spec.talents.thorns_of_iron[2] ),
        Zekili:GetSpellLinkWithTexture( spec.talents.reinforced_fur[2] ), spec.abilities.ironfur.name ),
    type = "range",
    min = 0,
    max = 200,
    step = 0.1,
