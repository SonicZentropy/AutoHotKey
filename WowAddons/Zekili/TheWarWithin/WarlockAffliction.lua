...
local spec = Zekili:NewSpecialization( 265 )
...
spec:RegisterStateExpr( "can_seed", function ()
    local seed_targets = min( active_enemies, Zekili:GetNumTTDsAfter( action.seed_of_corruption.cast + ( 6 * haste ) ) )
