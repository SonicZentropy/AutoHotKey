...
spec:RegisterSetting( "check_cone_range", true, {
    name = strformat( "%s: Range Check", Zekili:GetSpellLinkWithTexture( spec.abilities.cone_of_cold.id ) ),
