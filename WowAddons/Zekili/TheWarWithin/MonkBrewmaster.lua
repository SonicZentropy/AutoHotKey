...
spec:RegisterSetting( "purify_for_celestial", true, {
    name = strformat( "%s: Maximize Shield", Zekili:GetSpellLinkWithTexture( spec.abilities.celestial_brew.id ) ),
    desc = strformat( "If checked, %s may be recommended more frequently to build stacks of %s for your %s shield.\n\n" ..
        ...
        Zekili:GetSpellLinkWithTexture( spec.abilities.purifying_brew.id ), Zekili:GetSpellLinkWithTexture( spec.auras.purified_chi.id ),
        Zekili:GetSpellLinkWithTexture( spec.abilities.celestial_brew.id ), Zekili:GetSpellLinkWithTexture( spec.talents.light_brewing[2] ),
        spec.abilities.purifying_brew.name, Zekili:GetSpellLinkWithTexture( 115069 ) ),
    type = "toggle",
    width = "full",
} )
...
spec:RegisterSetting( "purify_for_niuzao", true, {
    name = strformat( "%s: Maximize %s", Zekili:GetSpellLinkWithTexture( spec.abilities.purifying_brew.id ),
        Zekili:GetSpellLinkWithTexture( spec.talents.improved_invoke_niuzao_the_black_ox[2] ) ),
    desc = strformat( "If checked, %s may be recommended when %s is active if %s is talented.\n\n"
        .. "This feature is used to maximize %s damage from your guardian.", Zekili:GetSpellLinkWithTexture( spec.abilities.purifying_brew.id ),
        Zekili:GetSpellLinkWithTexture( spec.abilities.invoke_niuzao.id ), Zekili:GetSpellLinkWithTexture( spec.talents.improved_invoke_niuzao_the_black_ox[2] ),
        Zekili:GetSpellLinkWithTexture( 227291 ) ),
    type = "toggle",
    width = "full"
} )
...
spec:RegisterSetting( "purify_stagger_currhp", 12, {
    name = strformat( "%s: %s Tick %% Current Health", Zekili:GetSpellLinkWithTexture( spec.abilities.purifying_brew.id ), Zekili:GetSpellLinkWithTexture( 115069 ) ),
    desc = strformat( "If set above zero, %s may be recommended when your current %s ticks for this percentage of your |cFFFFD100current|r effective health (or more).  "
        ...
        .. "This value is halved when playing solo.", Zekili:GetSpellLinkWithTexture( spec.abilities.purifying_brew.id ), Zekili:GetSpellLinkWithTexture( 115069 ) ),
    type = "range",
    min = 0,
    max = 100,
    step = 0.1,
...
spec:RegisterSetting( "purify_stagger_maxhp", 6, {
    name = strformat( "%s: %s Tick %% Maximum Health", Zekili:GetSpellLinkWithTexture( spec.abilities.purifying_brew.id ), Zekili:GetSpellLinkWithTexture( 115069 ) ),
...
spec:RegisterSetting( "bof_percent", 50, {
    name = strformat( "%s: Require %s %%", Zekili:GetSpellLinkWithTexture( spec.abilities.breath_of_fire.id ),
        Zekili:GetSpellLinkWithTexture( spec.abilities.keg_smash.id ) ),
    desc = strformat( "If set above zero, %s may be recommended only if this percentage of your identified targets are afflicted with %s.\n\n" ..
        ...
        Zekili:GetSpellLinkWithTexture( spec.abilities.breath_of_fire.id ), Zekili:GetSpellLinkWithTexture( spec.abilities.keg_smash.id ),
...
spec:RegisterSetting( "eh_percent", 65, {
    name = strformat( "%s: Health %%", Zekili:GetSpellLinkWithTexture( spec.abilities.expel_harm.id ) ),
    desc = strformat( "If set above zero, %s will not be recommended until your health falls below this percentage.",
        Zekili:GetSpellLinkWithTexture( spec.abilities.expel_harm.id ) ),
    type = "range",
    min = 0,
    max = 100,
    step = 1,
...
spec:RegisterSetting( "vivify_percent", 65, {
    name = strformat( "%s: Health %%", Zekili:GetSpellLinkWithTexture( spec.abilities.vivify.id ) ),
    desc = strformat( "If set above zero, %s will not be recommended until your health falls below this percentage.",
        Zekili:GetSpellLinkWithTexture( spec.abilities.vivify.id ) ),
    type = "range",
    min = 0,
    max = 100,
    step = 1,
