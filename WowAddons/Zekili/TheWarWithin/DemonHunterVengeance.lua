...
local spec = Zekili:NewSpecialization( 581 )
...
spec:RegisterSetting( "infernal_charges", 1, {
    name = strformat( "Reserve %s Charges", Zekili:GetSpellLinkWithTexture( 189110 ) ),
    desc = strformat( "If set above zero, %s will not be recommended if it would leave you with fewer charges.", Zekili:GetSpellLinkWithTexture( 189110 ) ),
    type = "range",
    min = 0,
    max = 2,
    step = 0.1,
...
spec:RegisterSetting( "brand_charges", 0, {
    name = strformat( "Reserve %s Charges", Zekili:GetSpellLinkWithTexture( spec.abilities.fiery_brand.id ) ),
    desc = strformat( "If set above zero, %s will not be recommended if it would leave you with fewer charges.", Zekili:GetSpellLinkWithTexture( spec.abilities.fiery_brand.id ) ),
    type = "range",
    min = 0,
    max = 2,
    step = 0.1,
...
spec:RegisterSetting( "frailty_stacks", 2, {
    name = strformat( "Require %s Stacks", Zekili:GetSpellLinkWithTexture( 389958 ) ),
    desc = function()
        return strformat( "If set above zero, the default priority will not recommend certain abilities unless you have at least this many stacks of %s on your target.\n\n"
            ...
            Zekili:GetSpellLinkWithTexture( 389958 ), Zekili:GetSpellLinkWithTexture( 389976 ), Zekili:GetSpellLinkWithTexture( 389985 ), spec.auras.frailty.name )
    end,
    type = "range",
    min = 0,
    max = 6,
