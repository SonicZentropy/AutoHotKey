...
spec:RegisterSetting( "single_zen_pulse", false, {
    type = "toggle",
    name = strformat( "%s: Single Target", Zekili:GetSpellLinkWithTexture( spec.abilities.zen_pulse.id ) ),
    desc = strformat( "If checked, %s may be recommended when there is only one enemy detected.\n\n"
        ...
        Zekili:GetSpellLinkWithTexture( spec.abilities.zen_pulse.id ), spec.abilities.zen_pulse.name ),
    width = "full",
} )
