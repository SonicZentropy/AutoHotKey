...
spec:RegisterSetting( "purify_for_niuzao", true, {
    name = strformat( "%s: Maximize %s", Zekili:GetSpellLinkWithTexture( spec.abilities.purifying_brew.id ),
        Zekili:GetSpellLinkWithTexture( spec.talents.improved_invoke_niuzao[2] ) ),
    desc = strformat( "If checked, %s may be recommended when %s is active if %s is talented.\n\n"
        ...
        Zekili:GetSpellLinkWithTexture( spec.abilities.invoke_niuzao.id ), Zekili:GetSpellLinkWithTexture( spec.talents.improved_invoke_niuzao[2] ),
